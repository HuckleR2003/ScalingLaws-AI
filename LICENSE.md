...
and new works based on the software.

## Notices

You must ensure that anyone who gets a copy of any part
of the software from you also gets a copy of these terms,
as well as the following copyright notice:

> Copyright 2026 Marcin Firmuga (HCK Labs)
...
Not part of the licence, just a plain reading of it.

**You may** read this code, learn from it, run it, change it, fork it, and share your fork, for any
purpose that is not commercial. Study, teaching, hobby projects and personal entertainment are all
fine, and so is writing about it.

**You may not** sell this game or a game built from it, put it on a store, or use it inside a
commercial product. If you want to do something commercial with any of it, ask:
kematex2202@gmail.com.

**Why not MIT**, since PC Workman is MIT: this repository has been public from the first commit and
is meant to stay readable, but a game heading for a store is a different thing from a system monitor.
Under MIT anyone could take this, build it and sell it, including the version that exists before the
project goes commercial. This licence keeps everything that made the repository useful and removes
only that.

**The Asset Store packs used for the office furniture and the character models are not in this
repository and are not covered by this licence.** Their own licences forbid redistribution, which is
why a fresh clone shows them as missing references.
