...
namespace ScalingLaws.Data
{
    ...
    public static class Loc
    {
        ...
        public static readonly Dictionary<string, string> English = new()
        {
            ...
            ["research.funding_note"] = "Buys about 6 points a month. Four times the money buys twice the points, so nobody purchases the tree outright. Building things earns more than paying for them.",
        ...
        public static readonly Dictionary<string, string> Polish = new()
        {
            ...
            ["research.funding_note"] = "Kupuje jakieś 6 punktów miesięcznie. Czterokrotność pieniędzy daje dwa razy tyle punktów, więc nikt nie wykupi całego drzewa. Budowanie daje więcej niż płacenie.",
