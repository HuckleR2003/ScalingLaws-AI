...
namespace ScalingLaws.Simulation
{
    ...
    public sealed class MailItem
    {
        ...
        /// <summary>
        /// The person behind a job offer, when one was generated by the hiring desk.
        ///
        /// Null on the older shape of job letter, which carried only a role and a band. The inbox
        /// checks for null rather than assuming, so a save written before people had names still
        /// opens without throwing.
        /// </summary>
        public Candidate Candidate { get; set; }

        /// <summary>What the company has put on the table, an hour. Starts at what they asked.</summary>
        public double OfferedHourlyUsd { get; set; }

        /// <summary>Offers made so far. At <see cref="Negotiation.Patience"/> they walk.</summary>
        ...
        public IReadOnlyList<MailAction> Actions
        {
            get
            {
                ...
                return Kind switch
                {
                    ...
                    MailKind.JobOffer => Candidate != null
