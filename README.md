...
[![Tests](https://img.shields.io/badge/tests-1423%20EditMode%20%2B%2069%20PlayMode-brightgreen)](#testing)
...
| `Assets/_ScalingLaws/Tests/EditMode/` | 1423 tests across 164 fixtures. None load a scene. |
| `Assets/_ScalingLaws/Tests/PlayMode/` | 69 tests that do load a scene, and render pages to PNG |
